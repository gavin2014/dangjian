...
//                        $values['admin_id'] =  ;
    ...
    {
        return ['0' => __('User_type All'),'1' => __('User_type 1'), '2' => __('User_type 2'), '3' => __('User_type 3'), '4' => __('User_type 4'),'5' => __('User_type 5')];
    }

    public function getActivityTypeList()
    {
        return ['1' => __('Activity_type 1'), '2' => __('Activity_type 2'), '3' => __('Activity_type 3')];
    }
