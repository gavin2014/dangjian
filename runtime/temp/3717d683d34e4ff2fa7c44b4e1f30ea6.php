<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:125:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/public/../application/admin/view/cms/archives/edit.html";i:1565001635;s:112:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/layout/default.html";i:1564308282;s:109:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/common/meta.html";i:1562338656;s:111:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <select  id="c-activity_type" class="form-control selectpicker" name="row[activity_type]" value="<?php echo $row['activity_type']; ?>">
                        ...
                        <div class="tab-pane fade active in" id="basic">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <?php echo Form::switcher('row[is_user_record]', $row['is_user_record'], ['color'=>'danger']); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group hidden">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <input type="text" class="form-control selectpage" data-source="cms/special/index" placeholder="所属专题,可为空" data-field="title" name="row[special_id]" value="<?php echo $row['special_id']; ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        <input id="c-title" data-rule="required" class="form-control <?php echo $row['style_bold']?'text-bold':''; ?>" name="row[title]" type="text" value="<?php echo htmlentities($row['title']); ?>" style="color:<?php echo $row['style_color']?$row['style_color']:'inherit'; ?>;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <input id="c-tags" data-rule="" class="form-control" placeholder="请输入后回车或空格确认" name="row[tags]" type="text" value="<?php echo htmlentities($row['tags']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <textarea id="c-content" data-rule="required" class="form-control editor" name="row[content]" rows="15"><?php echo htmlentities($row['content']); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class='input-group date datetimepicker'>
                                        <input type='text' name="row[publishtime]" data-date-format="YYYY-MM-DD HH:mm:ss" value="<?php echo $row['publishtime_text']; ?>" class="form-control datetimepicker"/>
