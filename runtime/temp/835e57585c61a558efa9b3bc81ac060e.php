<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:130:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/public/../application/admin/view/wis/activityrecord/add.html";i:1564664207;s:112:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/layout/default.html";i:1564308282;s:109:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/common/meta.html";i:1562338656;s:111:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-actice_detail"  class="form-control editor" rows="5" name="row[actice_detail]" cols="50"></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-actice_images" class="form-control hidden" size="50" name="row[actice_images]" type="text">
...
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-actual_number" class="form-control" name="row[actual_number]" type="number">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Absent_number'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-absent_number" class="form-control" name="row[absent_number]" type="number">-->
<!--        </div>-->
<!--    </div>-->
