<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"D:\workspace\php\dangjian\addons\cms\view\default\index.html";i:1565957032;s:68:"D:\workspace\php\dangjian\addons\cms\view\default\common\layout.html";i:1565957032;s:72:"D:\workspace\php\dangjian\addons\cms\view\default\common\index_list.html";i:1565957032;s:66:"D:\workspace\php\dangjian\addons\cms\view\default\common\item.html";i:1565957032;s:69:"D:\workspace\php\dangjian\addons\cms\view\default\common\sidebar.html";i:1565957032;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
...
<!--                    <?php $__7EHsu8Z5wm__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__7EHsu8Z5wm__) || $__7EHsu8Z5wm__ instanceof \think\Collection || $__7EHsu8Z5wm__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__7EHsu8Z5wm__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>-->
...
<!--                            <?php $__ioUdWuDxYQ__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__ioUdWuDxYQ__) || $__ioUdWuDxYQ__ instanceof \think\Collection || $__ioUdWuDxYQ__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ioUdWuDxYQ__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>-->
<!--                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>-->
<!--                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ioUdWuDxYQ__; ?>-->
<!--                        </ul>-->
<!--                    </li>-->
<!--                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__7EHsu8Z5wm__; ?>-->
<!--                </ul>-->
            ...
            <div class="swiper-container index-focus">
                ...
                <div id="index-focus" class="carousel slide carousel-focus" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php $__AE1iLxct2X__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__AE1iLxct2X__) || $__AE1iLxct2X__ instanceof \think\Collection || $__AE1iLxct2X__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__AE1iLxct2X__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        <li data-target="#index-focus" data-slide-to="<?php echo $i-1; ?>" class="<?php if($i==1): ?>active<?php endif; ?>"></li>
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__AE1iLxct2X__; ?>
                    </ol>
                    <div class="carousel-inner" role="listbox">
                        <?php $__JK6EHQFUkb__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__JK6EHQFUkb__) || $__JK6EHQFUkb__ instanceof \think\Collection || $__JK6EHQFUkb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__JK6EHQFUkb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__JK6EHQFUkb__; ?>
                    </div>
                    ...
                    <h3 class="panel-title">
                        ...
                        <div class="more hidden-xs">
                            <ul class="list-unstyled list-inline">
                                <!-- E 栏目筛选 -->
                                <?php $__KCrZ1eD3P5__ = \addons\cms\model\Channel::getChannelList(["id"=>"item","condition"=>"'list'=type","limit"=>"6"]); if(is_array($__KCrZ1eD3P5__) || $__KCrZ1eD3P5__ instanceof \think\Collection || $__KCrZ1eD3P5__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__KCrZ1eD3P5__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                <li><?php echo $item['textlink']; ?></li>
                                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__KCrZ1eD3P5__; ?>
                                <!-- E 栏目筛选 -->
                               </ul>
                        </div>
                    </h3>
...
<!-- S 首页列表 -->
<?php $__E9SIbc3dPG__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","cache"=>"false","orderby"=>"weigh","limit"=>"$offset,5"]); if(is_array($__E9SIbc3dPG__) || $__E9SIbc3dPG__ instanceof \think\Collection || $__E9SIbc3dPG__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__E9SIbc3dPG__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
...
<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__E9SIbc3dPG__; ?>
<!-- E 首页列表 -->
            ...
            <div class="panel panel-default lasest-update">
                ...
                <div class="panel-body">
                    <ul class="list-unstyled">
                        <?php $__CcK3RNX1FD__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","row"=>"6","orderby"=>"id","orderway"=>"desc"]); if(is_array($__CcK3RNX1FD__) || $__CcK3RNX1FD__ instanceof \think\Collection || $__CcK3RNX1FD__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__CcK3RNX1FD__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
                        <li>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__CcK3RNX1FD__; ?>
                    </ul>
                </div>
                <!-- E 最近更新 -->
...
<div class="panel panel-default hot-tags">
    ...
    <div class="panel-body">
        <div class="tags">
            <?php $__FqPpfjCJcy__ = \addons\cms\model\Tags::getTagsList(["id"=>"tag","orderby"=>"rand","limit"=>"30"]); if(is_array($__FqPpfjCJcy__) || $__FqPpfjCJcy__ instanceof \think\Collection || $__FqPpfjCJcy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__FqPpfjCJcy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?>
            <a href="<?php echo $tag['url']; ?>" class="tag"> <span><?php echo $tag['name']; ?></span></a>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__FqPpfjCJcy__; ?>
        </div>
    </div>
</div>
<!-- E 热门标签 -->
...
<div class="panel panel-default hot-article">
    ...
    <div class="panel-body">
        <?php $__BK6EGyICMd__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>1,"row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc"]); if(is_array($__BK6EGyICMd__) || $__BK6EGyICMd__ instanceof \think\Collection || $__BK6EGyICMd__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__BK6EGyICMd__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__BK6EGyICMd__; ?>
    </div>
</div>
<!-- E 热门资讯 -->
...
<div class="panel panel-default recommend-article">
    ...
    <div class="panel-body">
        <?php $__rESxjk5zH1__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>3,"row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc","addon"=>"political_study"]); if(is_array($__rESxjk5zH1__) || $__rESxjk5zH1__ instanceof \think\Collection || $__rESxjk5zH1__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__rESxjk5zH1__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        <div class="media media-number">
            <div class="media-left">
                <span class="num"><?php echo $i; ?></span>
            </div>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__rESxjk5zH1__; ?>
    </div>
</div>
<!-- E 推荐下载 -->
