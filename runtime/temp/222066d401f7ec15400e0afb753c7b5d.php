<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:129:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/public/../application/admin/view/cms/archives/addstudy.html";i:1564635710;s:112:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/layout/default.html";i:1564308282;s:109:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/common/meta.html";i:1562338656;s:111:"/Users/chenyun/Documents/项目/信息工程学院-智慧党建系统/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="panel panel-default panel-intro">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#basic" data-toggle="tab">添加课程信息</a></li>
                    </ul>
                </div>
                <div class="panel-body">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="basic">
                            ...
                            <div class="form-group">
                                <label for="c-title" class="control-label col-xs-12 col-sm-2"><?php echo __('课程名称'); ?>:</label>
                                <div class="col-xs-12 col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-2" for="c-avatar"><?php echo __('学习资源文件'); ?>:</label>
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        <input class="form-control hidden" data-rule="" id="c-avatar" name="row[study_files]" size="50" type="text" value="">
                                        <div class="input-group-addon no-border no-padding">
                                            <span><button class="btn btn-danger plupload" data-input-id="c-avatar" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-preview-id="p-avatar" id="plupload-avatar" type="button"><i class="fa fa-upload"></i> 选择文件<?php echo __('Upload'); ?></button></span>
                                        </div>
...
<!--                            <div id="extend"></div>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <textarea id="c-content"  class="form-control editor" name="row[content]" rows="15"></textarea>
