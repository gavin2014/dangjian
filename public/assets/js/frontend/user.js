define(['jquery', 'bootstrap', 'frontend', 'form', 'template','selectpage'], function ($, undefined, Frontend, Form, Template,selectpage) {
    ...
    var Controller = {
        ...
        register: function () {
            ...
            // Form.events.selectpage($("#register-form"));


                // Toastr.success($("#c-usergroup").data('params'));
            //为表单绑定事件
            ...
            //级连绑定
            $("#c-usergroup").data("params", function () {
                return {"school": $("#c-School").val()};
            });
        },
        changepwd: function () {
            //本地验证未通过时提示
